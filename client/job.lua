...
RegisterNetEvent('qb-policejob:ToggleDuty', function(data)
    local PlayerData = QBCore.Functions.GetPlayerData(data.source)
    ...
    TriggerServerEvent("police:server:UpdateBlips") --metadata['callsign']
    local message = {
     name = PlayerData.charinfo.firstname .." ".. PlayerData.charinfo.lastname,
     callsign = PlayerData.metadata['callsign'],
     DutyStat = DutyStat
    }
    TriggerServerEvent("police:server:CreateLog", "Duty", "Front Desk", color, message)
    --TriggerServerEvent("police:server:CreateLog", "asd", "Front Desk", color, (name .. " " .. callsign .. " " ..DutyStat))
    ...
    CreateThread(function()
        ...
        for k, v in pairs(Config.Locations["duty"]) do
            if Config.EnablePeds then
                QBCore.Functions.LoadModel(Config.PedsTable["DutyPed"].model)
                while not HasModelLoaded(Config.PedsTable["DutyPed"].model) do
                    Wait(100)
                end
                DutyPed = CreatePed(0, Config.PedsTable["DutyPed"].model, v.x, v.y, v.z-1.0, v.w, false, true)
                ...
                TaskStartScenarioInPlace(DutyPed, Config.PedsTable["DutyPed"].scenario, 0, true) 
            end
        ...
        for k, v in pairs(Config.Locations["armory"]) do
            if Config.EnablePeds then
                QBCore.Functions.LoadModel(Config.PedsTable["ArmoryPed"].model)
                while not HasModelLoaded(Config.PedsTable["ArmoryPed"].model) do
                    Wait(100)
                end
                ArmoryPed = CreatePed(0, Config.PedsTable["ArmoryPed"].model, v.x, v.y, v.z-1.0, v.w, false, true)
                ...
                TaskStartScenarioInPlace(ArmoryPed, Config.PedsTable["ArmoryPed"].scenario, 0, true) 
            end
        ...
        for k, v in pairs(Config.Locations["impound"]) do
            if Config.EnablePeds then
                QBCore.Functions.LoadModel(Config.PedsTable["ImpoundPed"].model)
                while not HasModelLoaded(Config.PedsTable["ImpoundPed"].model) do
                    Wait(100)
                end
                ImpoundPed = CreatePed(0, Config.PedsTable["ImpoundPed"].model, v.vehped.x, v.vehped.y, v.vehped.z-1.0, v.vehped.w, false, true)
                ...
                TaskStartScenarioInPlace(ImpoundPed, Config.PedsTable["ImpoundPed"].scenario, 0, true) 
            end
        ...
        for k, v in pairs(Config.Locations["helicopter"]) do
            if Config.EnablePeds then
                QBCore.Functions.LoadModel(Config.PedsTable["HeliPed"].model)
                while not HasModelLoaded(Config.PedsTable["HeliPed"].model) do
                    Wait(100)
                end
                HeliPed = CreatePed(0, Config.PedsTable["HeliPed"].model, v.vehped.x, v.vehped.y, v.vehped.z-1.0, v.vehped.w, false, true)
                ...
                TaskStartScenarioInPlace(HeliPed, Config.PedsTable["HeliPed"].scenario, 0, true)
            end
        ...
        for k, v in pairs(Config.Locations["vehicle"]) do
            if Config.EnablePeds then
                QBCore.Functions.LoadModel(Config.PedsTable["GaragePed"].model)
                while not HasModelLoaded(Config.PedsTable["GaragePed"].model) do
                    Wait(100)
                end
                GaragePed = CreatePed(0, Config.PedsTable["GaragePed"].model, v.vehped.x, v.vehped.y, v.vehped.z-1.0, v.vehped.w, false, true)
                ...
                TaskStartScenarioInPlace(GaragePed, Config.PedsTable["GaragePed"].scenario, 0, true) 
            end
        ...
        for k, v in pairs(Config.Locations["evidence"]) do
            if Config.EnablePeds then
                QBCore.Functions.LoadModel(Config.PedsTable["EvidencePed"].model)
                while not HasModelLoaded(Config.PedsTable["EvidencePed"].model) do
                    Wait(100)
                end
                EvidencePed = CreatePed(0, Config.PedsTable["EvidencePed"].model, v.x, v.y, v.z-1.0, v.w, false, true)
                ...
                TaskStartScenarioInPlace(EvidencePed, Config.PedsTable["EvidencePed"].scenario, 0, true) 
            end
