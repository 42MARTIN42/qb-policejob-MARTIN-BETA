local Translations = {
    error = {
        ...
        not_outhereized_veh = "You're not authorized for this vehicel type",
        non_outhereized_veh = 'There in no Outhereized vehicles for you!'
    },
    success = {
    ...
    menu = {
        ...
        heli_garage = 'Heli Garage',
        heli_garage_txt = 'Have nice walking flight',
    },
    email = {
